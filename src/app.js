...
import {
  ...
  AgentProfiles
} from "./constants.js?v=20260823_v67";
import { downloadFileBlob, escapeHtml, getCaretCharacterOffsetWithin, isTaskExpired } from "./utils.js?v=20260823_v67";
import { callCozeAgentAPI } from "./agents.js?v=20260823_v67";
import { AuthManager } from "./auth.js?v=20260823_v67";
import { CloudSyncEngine } from "./sync.js?v=20260823_v67";
import { renderLoginView } from "./login.js?v=20260823_v67";
import { renderTeacherPortal } from "./teacher.js?v=20260823_v67";
import { renderStudentTaskPortal } from "./student-portal.js?v=20260823_v67";
import {
  buildWordEditorHtml,
