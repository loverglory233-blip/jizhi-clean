...
import { downloadFileBlob, escapeHtml, getCaretCharacterOffsetWithin, isTaskExpired } from "./utils.js?v=20260823_v179";
import { callCozeAgentAPI } from "./agents.js?v=20260823_v179";
import { AuthManager } from "./auth.js?v=20260823_v179";
import { CloudSyncEngine } from "./sync.js?v=20260823_v179";
import { renderLoginView } from "./login.js?v=20260823_v179";
import { renderTeacherPortal } from "./teacher.js?v=20260823_v179";
import { renderStudentTaskPortal } from "./student-portal.js?v=20260823_v179";
import {
  buildWordEditorHtml,
  ...
  renderPresencePills,
  renderRemoteCursors
} from "./editor.js?v=20260823_v179";
