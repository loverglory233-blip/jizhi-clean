...
import { downloadFileBlob, escapeHtml, getCaretCharacterOffsetWithin, isTaskExpired } from "./utils.js?v=20260823_v22";
import { callCozeAgentAPI } from "./agents.js?v=20260823_v22";
import { AuthManager } from "./auth.js?v=20260823_v22";
import { CloudSyncEngine } from "./sync.js?v=20260823_v22";
import { renderLoginView } from "./login.js?v=20260823_v22";
import { renderTeacherPortal } from "./teacher.js?v=20260823_v22";
import { renderStudentTaskPortal } from "./student-portal.js?v=20260823_v22";
import {
  buildWordEditorHtml,
