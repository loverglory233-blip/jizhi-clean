...
import { AuthManager } from "./auth.js?v=20260823_v231";
import { CloudSyncEngine } from "./sync.js?v=20260823_v231";
import { renderLoginView } from "./login.js?v=20260823_v231";
import { renderTeacherPortal } from "./teacher.js?v=20260823_v231";
...
import {
  ...
  renderPresencePills,
  renderRemoteCursors
} from "./editor.js?v=20260823_v231";
