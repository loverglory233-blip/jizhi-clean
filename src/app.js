...
import { downloadFileBlob, escapeHtml, getCaretCharacterOffsetWithin } from "./utils.js?v=20260823_v9";
import { callCozeAgentAPI } from "./agents.js?v=20260823_v9";
import { AuthManager } from "./auth.js?v=20260823_v9";
import { CloudSyncEngine } from "./sync.js?v=20260823_v9";
import { renderLoginView } from "./login.js?v=20260823_v9";
import { renderTeacherPortal } from "./teacher.js?v=20260823_v9";
import { renderStudentTaskPortal } from "./student-portal.js?v=20260823_v9";
import {
  buildWordEditorHtml,
