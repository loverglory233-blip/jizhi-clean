...
import { downloadFileBlob, escapeHtml, getCaretCharacterOffsetWithin, isTaskExpired } from "./utils.js?v=20260825_v515";
import { callCozeAgentAPI } from "./agents.js?v=20260825_v515";
import { AuthManager } from "./auth.js?v=20260825_v515";
import { CloudSyncEngine } from "./sync.js?v=20260825_v515";
import { renderLoginView } from "./login.js?v=20260825_v515";
import { renderTeacherPortal } from "./teacher.js?v=20260825_v515";
import { renderStudentTaskPortal } from "./student-portal.js?v=20260825_v515";
import {
  buildWordEditorHtml,
  ...
  renderPresencePills,
  renderRemoteCursors
} from "./editor.js?v=20260825_v515";
