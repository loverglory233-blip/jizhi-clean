...
import {
  ...
  AgentProfiles
} from "./constants.js?v=20260823_v66";
import { downloadFileBlob, escapeHtml, getCaretCharacterOffsetWithin, isTaskExpired } from "./utils.js?v=20260823_v66";
import { callCozeAgentAPI } from "./agents.js?v=20260823_v66";
import { AuthManager } from "./auth.js?v=20260823_v66";
import { CloudSyncEngine } from "./sync.js?v=20260823_v66";
import { renderLoginView } from "./login.js?v=20260823_v66";
import { renderTeacherPortal } from "./teacher.js?v=20260823_v66";
import { renderStudentTaskPortal } from "./student-portal.js?v=20260823_v66";
import {
  buildWordEditorHtml,
