...
import {
  ...
  AgentProfiles
} from "./constants.js?v=20260823_v61";
import { downloadFileBlob, escapeHtml, getCaretCharacterOffsetWithin, isTaskExpired } from "./utils.js?v=20260823_v61";
import { callCozeAgentAPI } from "./agents.js?v=20260823_v61";
import { AuthManager } from "./auth.js?v=20260823_v61";
import { CloudSyncEngine } from "./sync.js?v=20260823_v61";
import { renderLoginView } from "./login.js?v=20260823_v61";
import { renderTeacherPortal } from "./teacher.js?v=20260823_v61";
import { renderStudentTaskPortal } from "./student-portal.js?v=20260823_v61";
import {
  buildWordEditorHtml,
