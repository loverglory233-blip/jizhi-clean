...
import { downloadFileBlob, escapeHtml, getCaretCharacterOffsetWithin, isTaskExpired } from "./utils.js?v=20260823_v228";
import { callCozeAgentAPI } from "./agents.js?v=20260823_v228";
import { AuthManager } from "./auth.js?v=20260823_v228";
import { CloudSyncEngine } from "./sync.js?v=20260823_v228";
import { renderLoginView } from "./login.js?v=20260823_v228";
import { renderTeacherPortal } from "./teacher.js?v=20260823_v228";
import { renderStudentTaskPortal } from "./student-portal.js?v=20260823_v228";
import {
  buildWordEditorHtml,
  ...
  renderPresencePills,
  renderRemoteCursors
} from "./editor.js?v=20260823_v228";
