...
import {
  ...
  AgentProfiles
} from "./constants.js?v=20260823_v58";
import { downloadFileBlob, escapeHtml, getCaretCharacterOffsetWithin, isTaskExpired } from "./utils.js?v=20260823_v58";
import { callCozeAgentAPI } from "./agents.js?v=20260823_v58";
import { AuthManager } from "./auth.js?v=20260823_v58";
import { CloudSyncEngine } from "./sync.js?v=20260823_v58";
import { renderLoginView } from "./login.js?v=20260823_v58";
import { renderTeacherPortal } from "./teacher.js?v=20260823_v58";
import { renderStudentTaskPortal } from "./student-portal.js?v=20260823_v58";
import {
  buildWordEditorHtml,
