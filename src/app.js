...
import {
  ...
  AgentProfiles
} from "./constants.js?v=20260823_v91";
import { downloadFileBlob, escapeHtml, getCaretCharacterOffsetWithin, isTaskExpired } from "./utils.js?v=20260823_v91";
import { callCozeAgentAPI } from "./agents.js?v=20260823_v91";
import { AuthManager } from "./auth.js?v=20260823_v91";
import { CloudSyncEngine } from "./sync.js?v=20260823_v91";
import { renderLoginView } from "./login.js?v=20260823_v91";
import { renderTeacherPortal } from "./teacher.js?v=20260823_v91";
import { renderStudentTaskPortal } from "./student-portal.js?v=20260823_v91";
import {
  buildWordEditorHtml,
