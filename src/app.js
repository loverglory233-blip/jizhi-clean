...
import {
  ...
  AgentProfiles
} from "./constants.js?v=20260823_v23";
import { downloadFileBlob, escapeHtml, getCaretCharacterOffsetWithin, isTaskExpired } from "./utils.js?v=20260823_v23";
import { callCozeAgentAPI } from "./agents.js?v=20260823_v23";
import { AuthManager } from "./auth.js?v=20260823_v23";
import { CloudSyncEngine } from "./sync.js?v=20260823_v23";
import { renderLoginView } from "./login.js?v=20260823_v23";
import { renderTeacherPortal } from "./teacher.js?v=20260823_v23";
import { renderStudentTaskPortal } from "./student-portal.js?v=20260823_v23";
import {
  buildWordEditorHtml,
