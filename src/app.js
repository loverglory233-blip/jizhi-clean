...
【本次即时指令】:
1. 答辩陈述：严格以组员上述真实辩护发言为基准进行学术化润色（80~120字），忠实保留组员提到的核心主张，严禁凭空编造组员未讨论的技术参数。
2. 主席发言：定案本题；${remainingOppCount > 0 ? `顺推【${nextLabel}】，必须明确引述反方针对该题的核心质疑原文（“${nextInqFullContent.slice(0, 80)}...”），并给出针对性破局思路。` : `宣布全部质询辩护完毕，提醒全员在右上方点击【✍️ 确认答辩完成】进入修改终稿。`}
