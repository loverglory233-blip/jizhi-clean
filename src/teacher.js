...
import { parseXLSXOrCSVFile, parseCSVText, downloadFileBlob, escapeHtml, isTaskExpired, formatDurationHuman, formatChatDisplayTime, formatStandardDateDash, filterAndDeduplicateChatLogs, enforceEtherpadReadonly, showGlobalBannerNotice, isSameId, normalizeId } from "./utils.js?v=20260907_v2861";
    ...
    btnOpenPaperModal.addEventListener('click', () => {
      ...
      submitBtn.addEventListener('click', async () => {
        try {
          ...
          const newPaper = await authManager.uploadReferencePaper({
            title,
            classId: selClassId,
