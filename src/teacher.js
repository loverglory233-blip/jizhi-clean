...
import { parseXLSXOrCSVFile, parseCSVText, downloadFileBlob, escapeHtml, isTaskExpired, formatDurationHuman, formatChatDisplayTime, formatStandardDateDash, filterAndDeduplicateChatLogs, enforceEtherpadReadonly, showGlobalBannerNotice } from "./utils.js?v=20260903_v1444";
  ...
  if (btnEnrollExisting) {
    btnEnrollExisting.addEventListener('click', () => {
      ...
      const updateCountTip = () => {
        ...
        if (tip) tip.textContent = `已勾选 ${cnt} 人`;
      };
      updateCountTip();
