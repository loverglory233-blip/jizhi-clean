...
echo "📦 正在为 Etherpad 逐一精准安装官方 Word 级学术排版与光标姓名气泡插件..."
...
for pkg in "${PLUGINS[@]}"; do
    echo "   📥 正在安装: $pkg ..."
    npm install --save "$pkg" --legacy-peer-deps --registry=https://registry.npmmirror.com || true
done
...
echo "🎉🎉🎉 Etherpad 官方 Word 级排版与光标姓名插件已全部安装并加载就绪！"
